...
public class AdminVerPostresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_ver_postres);
        ...
        recyclerView = findViewById(R.id.recyclerAdminPostres);
        tvVolver = findViewById(R.id.tvAdminPostresVolver);

        PN = new ProductoNegocio(this);

        //Supongamos que la categoría "Platillos" tiene ID = 1
        List<Producto> listaPlatillos = PN.listarPorCategoria(3);
