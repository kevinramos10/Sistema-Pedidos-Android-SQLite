...
public class AdminVerBebidasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_ver_bebidas);
        ...
        recyclerView = findViewById(R.id.recyclerAdminBebidas);
        tvVolver = findViewById(R.id.tvAdminBebidasVolver);

        PN = new ProductoNegocio(this);

        //Supongamos que la categoría "Platillos" tiene ID = 1
        List<Producto> listaPlatillos = PN.listarPorCategoria(2);
