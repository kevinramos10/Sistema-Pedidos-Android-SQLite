...
public class ClienteAdicionalesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cliente_adicionales);
        ...
        recyclerView = findViewById(R.id.recyclerClientesAdicionales);
        tvVolver = findViewById(R.id.tvClientesAdicionalesVolver);
        PN = new ProductoNegocio(this);

        // Categoria 4 = Adicionales
        List<Producto> listaAdicionales = PN.listarPorCategoria(4);

        adapter = new ItemClientePlatillos(this, listaAdicionales);
