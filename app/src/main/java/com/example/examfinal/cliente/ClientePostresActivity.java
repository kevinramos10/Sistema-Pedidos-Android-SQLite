...
public class ClientePostresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cliente_postres);
        ...
        recyclerView = findViewById(R.id.recyclerClientesPostres);
        tvVolver = findViewById(R.id.tvClientesPostresVolver);
        PN = new ProductoNegocio(this);

        // Categoria 3 = Postres
        List<Producto> listaPostres = PN.listarPorCategoria(3);

        adapter = new ItemClientePlatillos(this, listaPostres);
